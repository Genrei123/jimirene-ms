...
public class Branch {
    ...
    @JsonProperty("branch_name") // This ensures proper mapping for snake_case in the request
    private String branchName;

    @JsonProperty("branch_address") // This ensures proper mapping for snake_case in the request
